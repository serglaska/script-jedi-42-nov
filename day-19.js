// task http://tddbin.com/#?kata=es6/language/template-strings/basics
...
// task http://tddbin.com/#?kata=es6/language/template-strings/multiline
...
// task http://tddbin.com/#?kata=es6/language/template-strings/tagged
  ...
  describe('the tag function can access each part of the template', function () {
    describe('the 1st parameter receives only the pure strings of the template string', function () {
      ...
      it('expressions are NOT passed to it', function () {
        const two = 'two';
        var tagged = tagFunction`one${555}two`;
    ...
    describe('the 2nd and following parameters contain the values of the processed substitution', function () {
      ...
      it('the 2nd parameter contains the first expression`s value', function () {
        function firstValueOnly(strings) {
          return `${one}`;
        }
...
// task http://tddbin.com/#?kata=es6/language/template-strings/raw
...
// task http://tddbin.com/#?kata=es6/language/spread/with-strings
