// task http://tddbin.com/#?kata=es6/language/symbol/basics
...
// task http://tddbin.com/#?kata=es6/language/symbol/for
...
describe('`Symbol.for` for registering Symbols globally', function () {
  ...
  it('is different to `Symbol()` which creates a symbol every time and does not store it', function () {
    ...
    var localSymbol = Symbol.for('symbol');
...
// task http://tddbin.com/#?kata=es6/language/symbol/keyFor
