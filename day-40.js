// task http://tddbin.com/#?kata=es6/language/generator/creation
...
// task http://tddbin.com/#?kata=es6/language/generator/iterator
...
// task http://tddbin.com/#?kata=es6/language/generator/yield
...
// task http://tddbin.com/#?kata=es6/language/generator/send-value
...
// task http://tddbin.com/#?kata=es6/language/generator/send-function
...
// task  http://tddbin.com/#?kata=es6/language/generator/return
...
describe('`return` in a generator function is special', function () {
  describe('the returned value is an IteratorResult (just like any value returned via `yield`)', function () {
    it('returns an IteratorResult (an object with the properties `value` and `done`)', function () {
      ...
      const returned = generatorFunction();
      const propertyNames = [];
