// task http://tddbin.com/#?kata=es6/language/object-literal/basics
...
// task http://tddbin.com/#?kata=es6/language/object-literal/computed-properties
...
// task http://tddbin.com/#?kata=es6/language/object-literal/getter
...
// task http://tddbin.com/#?kata=es6/language/object-literal/setter
...
describe('An object literal can also contain setters', () => {
  describe('defining: a setter', function () {
    ...
    it('must have exactly one parameter', function () {
      ...
      const obj = {
        set x(one) { // <<<<=== it's not a setter yet!
...
// task http://tddbin.com/#?kata=es6/language/class/creation
...
describe('Class creation', () => {
  it('is as simple as `class XXX {}`', function () {
    const TestClass = {};
    const instance = Object.create(TestClass);
  ...
  it('multiple methods need no commas (opposed to object notation)', function () {
    class User {
      wroteATest(value) { this.everWroteATest = true; }
  ...
  it('anonymous class', () => {
    const classType = typeof Function.prototype;
    assert.equal(classType, 'function');
  });
});

// task  http://tddbin.com/#?kata=es6/language/class/accessors
...
// task http://tddbin.com/#?kata=es6/language/class/static
...
// task http://tddbin.com/#?kata=es6/language/class/extends
...
// task http://tddbin.com/#?kata=es6/language/class/more-extends
...
// task http://tddbin.com/#?kata=es6/language/class/super-in-method
